...
Now, lets say you have multiple classes that share behaviors. Instead of re-writing all that code in each class, Ruby provides a few ways to create re-usable code. In this post I will walk you through two ways to provide re-usable behaviors to classes: inheritance and modules.
...
Now any instance created from either the Actor and Singer class will have access to the deep_breath method defined inside the BreathSupport module.
